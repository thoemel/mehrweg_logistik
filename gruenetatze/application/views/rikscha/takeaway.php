...
echo '
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			' . form_input(array('id' => 'depotkarten_bringt', 'name' => 'depotkarten_bringt', 'value' => set_value('depotkarten_bringt'), 'class' => 'form-control')) . '
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			' . form_input(array('id' => 'tk_dreckig_ganz', 'name' => 'tk_dreckig_ganz', 'value' => set_value('tk_dreckig_ganz'), 'class' => 'form-control')) . '
		</div>
	</div>
	<div class="form-group">
		<label for="bbb_dreckig_ganz" class="col-sm-5 control-label">Bring-Back-Boxen gebraucht</label>
		<div class="col-sm-2">
			' . form_input(array('id' => 'bbb_dreckig_ganz', 'name' => 'bbb_dreckig_ganz', 'value' => set_value('bbb_dreckig_ganz'), 'class' => 'form-control')) . '
		</div>
	</div>
	<div class="form-group">
		<label for="tk_defekt" class="col-sm-5 control-label">Transportkisten defekt</label>
		<div class="col-sm-2">
			' . form_input(array('id' => 'tk_defekt', 'name' => 'tk_defekt', 'value' => set_value('tk_defekt'), 'class' => 'form-control')) . '
		</div>
	</div>
	<div class="form-group">
		<label for="bbb_defekt_mit_depot" class="col-sm-5 control-label">BBB defekt mit Depotrückgabe</label>
		<div class="col-sm-2">
			' . form_input(array('id' => 'bbb_defekt_mit_depot', 'name' => 'bbb_defekt_mit_depot', 'value' => set_value('bbb_defekt_mit_depot'), 'class' => 'form-control')) . '
		</div>
	</div>
	<div class="form-group">
		<label for="bbb_defekt_ohne_depot" class="col-sm-5 control-label">BBB defekt ohne Depotrückgabe</label>
		<div class="col-sm-2">
			' . form_input(array('id' => 'bbb_defekt_ohne_depot', 'name' => 'bbb_defekt_ohne_depot', 'value' => set_value('bbb_defekt_ohne_depot'), 'class' => 'form-control')) . '
		</div>
	</div>
	<div class="form-group">
		<label for="depotkarten_holt" class="col-sm-5 control-label">Depotkarten</label>
		<div class="col-sm-2">
			' . form_input(array('id' => 'depotkarten_holt', 'name' => 'depotkarten_holt', 'value' => set_value('depotkarten_holt'), 'class' => 'form-control')) . '
		</div>
	</div>
